                        ...
                        <ul
                            ...
                            <li class="mr-3 flex-1">
                                <a href="{{ route('admin.tpsuara.index') }}"
                                    ...
                                    <i class="fa fa-address-card pr-0 md:pr-3"></i><span
                                        class="pb-1 md:pb-0 text-xs md:text-base text-gray-400 md:text-gray-200 block md:inline-block">DETAIL MAHASISWA</span>
                                </a>
                            ...
                            <li class="mr-3 flex-1">
                                <a href="{{ route('admin.dapil.index') }}"
                                    class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800  hover:border-pink-500">
                                    <i class="fa fa-address-card pr-0 md:pr-3"></i><span
                                        class="pb-1 md:pb-0 text-xs md:text-base text-gray-400 md:text-gray-200 block md:inline-block">DETAIL BANK</span>
                                </a>
                            </li>
                            <li class="mr-3 flex-1">
                                <a href="{{ route('admin.kecamatan.index') }}"
                                    class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-pink-500">
                                    <i class="fa fa-address-card pr-0 md:pr-3"></i><span
                                        class="pb-1 md:pb-0 text-xs md:text-base text-gray-400 md:text-gray-200 block md:inline-block">PEMBAYARAN</span>
                                </a>
                            </li>
                            ...
                            <li class="mr-3 flex-1">
                                <a href="{{ route('admin.laporan.index') }}"
                                    ...
                                    <i class="fas fa-chart-area pr-0 md:pr-3 text-blue-600"></i><span
                                        class="pb-1 md:pb-0 text-xs md:text-base text-white md:text-white block md:inline-block">DETAIL PEMBAYARAN</span>
