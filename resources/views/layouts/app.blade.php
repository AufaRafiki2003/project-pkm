                ...
                <div class="bg-gray-800 shadow-xl h-20 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:w-48 content-center">
                    ...
                    <div class="md:mt-12 md:w-48 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                        <ul
                            ...
                            <li class="mr-3 flex-1">
                                <a href="{{ route('admin.SuratCuti.index') }}"
                                    class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 ">
                                    <i class=""></i><span
                                        class="pb-1 md:pb-0 text-xs md:text-base text-white md:text-white block md:inline-block">Surat Cuti</span>
                            ...
                            <li class="mr-3 flex-1">
                                <a href="{{ route('admin.SuratCuti.index') }}"
                                    class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 ">
                                    <i class=""></i><span
                                        class="pb-1 md:pb-0 text-xs md:text-base text-white md:text-white block ">Surat Pindah</span>
